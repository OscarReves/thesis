...
def main():
    ...
    # Load model
    save_path = 'checkpoints/epoch_3.pt'
    ...
    model.save_pretrained("models/e5_finetuned_epoch3")

    # Upload to the hub
    model.push_to_hub("e5_finetuned_epoch3")
    tokenizer.push_to_hub("e5_finetuned_epoch3")
